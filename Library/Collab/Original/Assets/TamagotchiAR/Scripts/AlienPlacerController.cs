...
public class AlienPlacerController : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        // Frame.TrackingState = TrackingState.Paused;
                ...
                if (instantiatedPrefab < ScenePrefab.Length)
                {
                    ...
                    {   
                        ...
                        if (current == null)
                        {
                            ...
                            // Vector3 dist = new Vector3(0f, 0.08f, 2.5f);
                            // current.transform.Translate(dist);
                        }
                        /*
                        RaycastHit hit;
                    ...
                    if (touch.phase == TouchPhase.Ended)
                    {
                        ...
                        /* RaycastHit hit;
                         ...
                         {                            
                                 ...
                                 current.transform.position = hit.point;//dest;
                             // Do something with the object that was hit by the raycast.
                             if (hit.collider.gameObject.tag == "Ground" && !buildColliding)
                             {
